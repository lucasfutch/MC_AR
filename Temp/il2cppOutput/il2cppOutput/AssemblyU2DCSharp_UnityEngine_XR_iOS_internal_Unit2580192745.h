...
public:
	...
	uint32_t ___getPointCloudData_5;
...
public:
	...
	inline static int32_t get_offset_of_getPointCloudData_5() { return static_cast<int32_t>(offsetof(internal_UnityARCamera_t2580192745, ___getPointCloudData_5)); }
	inline uint32_t get_getPointCloudData_5() const { return ___getPointCloudData_5; }
	inline uint32_t* get_address_of_getPointCloudData_5() { return &___getPointCloudData_5; }
	inline void set_getPointCloudData_5(uint32_t value)
	{
		___getPointCloudData_5 = value;
	}
};
